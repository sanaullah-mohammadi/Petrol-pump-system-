...
API Specification
Property Value
Endpoint GET https://app-bqosbzxnngu9-api-pLVzAEz1ZQOL.gateway.appmedo.com/v1/videos/omni-video/{task_id}
HTTP Method GET
...
`https://app-bqosbzxnngu9-api-pLVzAEz1ZQOL.gateway.appmedo.com/v1/videos/omni-video/${encodeURIComponent(taskId)}`,
{
method: "GET",
headers: {
