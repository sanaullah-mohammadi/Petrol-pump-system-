...
Verify that none of bounding boxes intersect and that the entry bounding boxes are tall enough by checking the fields.json file with the check_bounding_boxes.py script (run from this file's directory): python scripts/check_bounding_boxes.py <JSON file>
