...
// Step 1: Submit task
const submitResp = await fetch("https://app-bqosbzxnngu9-api-2Y00Vzbe0MBY.gateway.appmedo.com/v1/images/omni-image", {
method: "POST",
headers: {
...
await new Promise(r => setTimeout(r, POLL_INTERVAL_MS));
    ...
    const queryResp = await fetch(
      `https://app-bqosbzxnngu9-api-n9QVxo8blgrL.gateway.appmedo.com/v1/images/omni-image/${taskId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
