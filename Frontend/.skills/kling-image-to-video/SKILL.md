...
Overview
Item Details
Create Task Endpoint POST https://app-bqosbzxnngu9-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations
Query Task Endpoint GET https://app-bqosbzxnngu9-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/{task_id}
...
"https://app-bqosbzxnngu9-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations",
{
method: "POST",
headers: {
...
const response = await fetch(
`https://app-bqosbzxnngu9-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/${taskId}`,
{
method: "GET",
headers: {
"Content-Type": "application/json",
