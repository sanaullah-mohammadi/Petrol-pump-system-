...
Property Value
Endpoint GET https://app-bqosbzxnngu9-api-w9Rbo8E7p2b9.gateway.appmedo.com/v6/latest/{base_currency}
...
const url = `https://app-bqosbzxnngu9-api-w9Rbo8E7p2b9.gateway.appmedo.com/v6/latest/${baseCurrency.toUpperCase()}`;
...
`https://app-bqosbzxnngu9-api-w9Rbo8E7p2b9.gateway.appmedo.com/v6/latest/${baseCurrency.toUpperCase()}`,
{
method: "GET",
headers: {
"Accept": "application/json",
