...
API Specification
Property Value
Endpoint POST https://app-bqosbzxnngu9-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech
HTTP Method POST
...
const response = await fetch("https://app-bqosbzxnngu9-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech", {
method: "POST",
headers: {
...
curl -s -X POST "https://app-bqosbzxnngu9-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech" \
...
// --- Call upstream ---
const upstream = await fetch("https://app-bqosbzxnngu9-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech", {
method: "POST",
headers: {
"Content-Type": "application/json",
"X-Gateway-Authorization": `Bearer ${apiKey}`,
