...
API Specification
Property Value
Endpoint GET https://app-bqosbzxnngu9-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/{id}
HTTP Method GET
...
`https://app-bqosbzxnngu9-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/${encodeURIComponent(taskId)}`,
{
method: "GET",
headers: {
