name: kling-text-to-video description: Generate short videos from text prompts using the Kling AI text-to-video API. Use this skill whenever the user wants to create a video from a script, scene description, or keywords — for e-commerce marketing, creative promotion, educational content, or entertainment production. license: MIT
Kling Text-to-Video
Overview
...
Property Value
Submit Endpoint POST https://app-bqosbzxnngu9-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video
Query Endpoint GET https://app-bqosbzxnngu9-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/{id}
