All News API
Endpoint: GET https://app-bqosbzxnngu9-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all
...
`https://app-bqosbzxnngu9-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all${qs ? `?${qs}` : ""}`,
{
method: "GET",
headers: {
