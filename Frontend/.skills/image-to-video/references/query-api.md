...
API Overview
Item Details
Endpoint GET https://app-bqosbzxnngu9-api-oYA6Z8wDBRDa.gateway.appmedo.com/v1/videos/image2video/{id}
...
`https://app-bqosbzxnngu9-api-oYA6Z8wDBRDa.gateway.appmedo.com/v1/videos/image2video/${encodeURIComponent(taskId)}`,
{
method: "GET",
headers: {
"Content-Type": "application/json",
