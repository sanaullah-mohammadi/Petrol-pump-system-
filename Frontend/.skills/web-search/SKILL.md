name: web-search description: Retrieve real-time web search results via the Smart Search API for fact-checking, news updates, and knowledge lookup. license: MIT
Overview
...
Endpoint: GET https://app-bqosbzxnngu9-api-VaOwP8E7dKEa.gateway.appmedo.com/search/FgEFxazBTfRUumJx/smart
...
`https://app-bqosbzxnngu9-api-VaOwP8E7dKEa.gateway.appmedo.com/search/FgEFxazBTfRUumJx/smart?${params.toString()}`,
{
method: "GET",
headers: {
