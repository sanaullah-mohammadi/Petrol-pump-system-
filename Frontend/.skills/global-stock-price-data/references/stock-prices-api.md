Stock Prices API
Endpoint: GET https://app-bqosbzxnngu9-api-oYA6Z8wDBN1a.gateway.appmedo.com/v1/data/quote
...
`https://app-bqosbzxnngu9-api-oYA6Z8wDBN1a.gateway.appmedo.com/v1/data/quote?${query.toString()}`,
