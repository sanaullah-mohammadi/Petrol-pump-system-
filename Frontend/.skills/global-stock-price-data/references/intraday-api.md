...
Endpoint: GET https://app-bqosbzxnngu9-api-pLVzJ8y7V3KL.gateway.appmedo.com/v1/data/intraday
...
`https://app-bqosbzxnngu9-api-pLVzJ8y7V3KL.gateway.appmedo.com/v1/data/intraday?${query.toString()}`,
