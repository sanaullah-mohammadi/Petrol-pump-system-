...
Endpoint: GET https://app-bqosbzxnngu9-api-V9gDze3qV2PL.gateway.appmedo.com/v1/data/eod
...
`https://app-bqosbzxnngu9-api-V9gDze3qV2PL.gateway.appmedo.com/v1/data/eod?${query.toString()}`,
