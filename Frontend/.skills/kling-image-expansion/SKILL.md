...
Capability Overview
Item Details
Create Task Endpoint POST https://app-bqosbzxnngu9-api-GYX1bbkRQj4a.gateway.appmedo.com/v1/images/editing/expand
Query Task (Single) Endpoint GET https://app-bqosbzxnngu9-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/{task_id}
Query Task (List) Endpoint GET https://app-bqosbzxnngu9-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand
...
"https://app-bqosbzxnngu9-api-GYX1bbkRQj4a.gateway.appmedo.com/v1/images/editing/expand",
{
method: "POST",
headers: {
...
const response = await fetch(
`https://app-bqosbzxnngu9-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/${taskId}`,
{
method: "GET",
headers: {
"Content-Type": "application/json",
