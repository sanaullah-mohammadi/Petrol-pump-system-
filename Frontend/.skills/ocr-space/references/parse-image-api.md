...
Property Value
Endpoint POST https://app-bqosbzxnngu9-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image
...
const response = await fetch("https://app-bqosbzxnngu9-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
method: "POST",
headers: {
...
// --- Call upstream ---
const upstream = await fetch("https://app-bqosbzxnngu9-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
method: "POST",
headers: {
