...
Property Value
Endpoint GET https://app-bqosbzxnngu9-api-m9xKXDbRplNa.gateway.appmedo.com/parse/imageurl
...
`https://app-bqosbzxnngu9-api-m9xKXDbRplNa.gateway.appmedo.com/parse/imageurl?${params.toString()}`,
{
method: "GET",
headers: {
